...
import com.annotation.ParamXssPass;
import com.annotation.ValidationParam;
import com.aspect.AspectApiImpl;
import com.aspect.ParamXssPassAspect;
import com.aspect.RecordLogAspect;
import com.aspect.ValidationParamAspect;
...
public class ControllerAspect {
    ...
    public Object validationPoint(ProceedingJoinPoint pjp)throws Throwable{
        ...
        if (method.isAnnotationPresent(AccessLimit.class)) {
            new com.liugh.aspect.AccessLimitAspect(aspectApi).doHandlerAspect(pjp,method);
        }
        //是否需要拦截xss攻击
