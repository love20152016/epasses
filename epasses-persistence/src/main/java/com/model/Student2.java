...
public class Student2 {
    ...
    @ExcelField(title = "入学日期", order = 3, writeConverter = com.model.Student2DateConverter.class)
    private Date date;
    ...
    @ExcelField(title = "是否开除", order = 5, readConverter = com.model.Student2ExpelConverter.class)
